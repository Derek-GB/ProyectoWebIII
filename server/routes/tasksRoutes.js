...
import * as tasksService from '../services/tasksService.js';  // Importa todo como objeto 'tasksService'
...
router.get('/', async (req, res) => {
  try {
    const tasks = await tasksService.getAll();  // Usa tasksService.getAll()
    res.json(tasks);
  } catch (err) {
